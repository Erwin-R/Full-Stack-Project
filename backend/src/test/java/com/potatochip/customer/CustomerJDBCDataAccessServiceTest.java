...
class CustomerJDBCDataAccessServiceTest extends AbstractTestContainers {
    ...
    void selectAllCustomers() {
        //giving customer so in cases where we have no customers in database, the test will not give false error
        //also giving unique emails since we have a unique constraint on customer emails
        //Given
    ...
    void willNotUpdateWhenNothingToUpdate() {
        ...
        //check that what we get back is exact same thing as customer
        assertThat(actual).isPresent().hasValueSatisfying(c -> {
            assertThat(c.getId()).isEqualTo(id);
            assertThat(c.getName()).isEqualTo(customer.getName());
            assertThat(c.getEmail()).isEqualTo(customer.getEmail());
